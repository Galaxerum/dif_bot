...
async def start_handler(message: types.Message):
    ...
    if not args:
        if not portfolio or portfolio.strip() == "":
            greeting = (
                f"👋Привет, {first_name}!\n"
                "Я — Комьюнити Бот Силы Сообществ.\n"
                "Моя задача — познакомить тебя с людьми, которые могут стать твоими союзниками, партнёрами, а может, и друзьями.\n"
                "Расскажи немного о себе — и я помогу найти тебе «своих» в этом зале."
